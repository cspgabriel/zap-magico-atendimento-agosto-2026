...
export default function Inbox({ accountId = 'default' }: { accountId?: string }) {
  ...
  return <div style={{ height: '100%', minHeight: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
    ...
    <div style={{ flex: 1, minHeight: 0, display: 'grid', gridTemplateColumns: 'minmax(270px, 33%) minmax(0, 1fr)', border: `1px solid ${colors.border}`, borderRadius: 8, overflow: 'hidden', background: colors.surface }}>
      ...
      {selected ? <section style={{ minWidth: 0, minHeight: 0, position: 'relative', display: 'grid', gridTemplateRows: 'auto auto minmax(0, 1fr) auto', overflow: 'hidden' }}>
        ...
        <div ref={scrollRef} style={{ minHeight: 0, overflow: 'auto', padding: 16, background: colors.bg }}>
        ...
        <footer onKeyDown={e => { if (e.ctrlKey && e.key === 'Enter') void sendReply() }} style={{ minHeight: 86, maxHeight: '45%', overflow: 'auto', padding: 9, borderTop: `1px solid ${colors.border}`, background: colors.surface }}>
